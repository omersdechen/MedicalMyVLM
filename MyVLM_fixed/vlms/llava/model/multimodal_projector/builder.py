...
class VisionProjector(nn.Module):
    ...
    def forward(self, x, concept_signals=None):
        # print("\n\nLinear Weights dtype:", self.linear1.weight.dtype)
        # print("x dtype:", x.dtype)
        # if concept_signals is not None:
        #     print("Concept signals dtype:", concept_signals.dtype)

        out = self.linear1(x)
        # print("out dtype:", out.dtype)

        out = self.act(out)
        # print("out2 dtype:", out.dtype)

        # print("asdasdasdasdSHIT")
        out = self.linear2(out, concept_signals) if type(self.linear2) == MyVLMLayer else self.linear2(out)
        # print("asdasdasdasdSHIT2")
