...
def load_pretrained_model(model_path, model_base, model_name, load_8bit=False, load_4bit=True, device_map="auto",
    ...
    if 'llava' in model_name.lower():
        ...
        if 'lora' in model_name.lower() and model_base is not None:
            ...
            # print("HOLAAALALALALALAAL3")
            if 'mpt' in model_name.lower():
                tokenizer = AutoTokenizer.from_pretrained(model_path, use_fast=True)
                model = LlavaMPTForCausalLM.from_pretrained(model_path, low_cpu_mem_usage=True, **kwargs)
            elif 'mistral' in model_name.lower():
                print('\n\nLoading LLaVA MISTRAL')
            ...
            # print('Convert to FP16...omer') #omer
            # model.to(torch.float16)
    else:
        # Load language model
        print("HOLEAASDAasdasdaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaSDAO")
        ...
        if model_base is not None:
            ...
            if 'mpt' in model_name.lower():
                ...
                model = AutoModelForCausalLM.from_pretrained(model_path, low_cpu_mem_usage=True, trust_remote_code=True,
                                                             **kwargs)
                print("HOLEAASDAasdasdaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaSDAO123")

            else:
                tokenizer = AutoTokenizer.from_pretrained(model_path, use_fast=False)
                model = AutoModelForCausalLM.from_pretrained(model_path, low_cpu_mem_usage=True, **kwargs)
                print("HOLEAASDAasdasdaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaSDAO123123")
