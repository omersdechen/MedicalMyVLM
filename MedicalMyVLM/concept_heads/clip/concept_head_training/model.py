...
class CLIPLinearClassifier(nn.Module):
    ...
    def __init__(self, model: nn.Module, num_labels: int = 2, hidden_size: int = 1024):
        ...
        self.projector = nn.Linear(512, 1024)  # omer Project BiomedCLIP features to 1024
    ...
    def forward(self, x: torch.Tensor) -> torch.Tensor:
        ...
        features = self.projector(features)  # Adjust dimensions

        # self.projector = nn.Linear(512, 1024)  # Project BiomedCLIP features to 1024
        #omer
